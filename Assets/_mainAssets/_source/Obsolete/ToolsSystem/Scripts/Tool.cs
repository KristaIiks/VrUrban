...
namespace ToolsSystem
{
	public abstract class Tool : MonoBehaviour
	{
		...
		[SerializeField] protected Gradient CanSelectGrad;
		...
		protected void SetRayColor(Gradient _gradient) => _line.colorGradient = _gradient;
		...
		public void DistanceSelect(Selectable _obj)
		{
			OpenMenu(_obj._params);
			_source.PlayOneShot(_selectClip);
